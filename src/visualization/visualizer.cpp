...
bool Visualizer::gaussian_distribution_radius_table_initialized_ = false;


Visualizer::Visualizer(const char* topic)
{
...
void Visualizer::drawSphere(const char* ns, const Eigen::Vector3d& center, double radius)
{
...
void Visualizer::drawGaussianDistribution(const char* ns, const Eigen::Vector3d& mu, const Eigen::Matrix3d& sigma, double probability, double offset)
{
...
void Visualizer::clearUptoCapacity(const char* ns)
{
    visualization_msgs::Marker marker;
